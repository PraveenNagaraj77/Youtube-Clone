...
import logo from "../assets/Youtube-Logo-White.png";
  ...
  return (
    <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between fixed w-full z-10">
      ...
      <div className="h-10 flex flex-row items-center ">
        <div className="w-[593px] bg-yt-black flex border border-yt-light-black items-center rounded-3xl h-18 sm:border-none">
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-yt-black h-6 ml-6 text-yt-white text-start focus:outline-none pl-4 hidden sm:block "
          />
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-row items-center">
          ...
          <div className="mx-3 p-2 w-10 hover:bg-yt-black rounded-full cursor-pointer">
